    ...
    379: (t) => {
      ...
      function n(t, n) {
        for (var i = {}, a = [], c = 0; c < t.length; c++) {
          const s = t[c];
          const l = n.base ? s[0] + n.base : s[0];
          const u = i[l] || 0;
          const p = ''.concat(l, ' ').concat(u);
          i[l] = u + 1;
          const f = r(p);
          const d = {
            css: s[1],
          ...
          if (f !== -1) e[f].references++, e[f].updater(d);
          else {
            const m = o(d, n);
            (n.byIndex = c), e.splice(c, 0, { identifier: p, updater: m, references: 1 });
          }
          a.push(p);
        }
        return a;
      ...
      t.exports = function (t, o) {
        ...
        return function (t) {
          ...
          for (var s = n(t, o), l = 0; l < i.length; l++) {
            const u = r(i[l]);
            e[u].references === 0 && (e[u].updater(), e.splice(u, 1));
          }
          i = s;
        };
      };
  ...
  (r.n = (t) => {
    ...
    (() => {
      ...
      function v() {
        ...
        function s(t, e, r, n) {
          const o = e && e.prototype instanceof p ? e : p;
            ...
            (i._invoke = (function (t, e, r) {
              ...
              return function (o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  const s = l(t, e, r);
                  if (s.type === 'normal') {
                    if (((n = r.done ? 'completed' : 'suspendedYield'), s.arg === u)) continue;
        ...
        const y = (d.prototype = p.prototype = Object.create(m));
        function w(t) {
        ...
        function x(t, e) {
          function n(o, i, a, c) {
            ...
            if (s.type !== 'throw') {
              const u = s.arg;
              const p = u.value;
              return p && g(p) == 'object' && r.call(p, '__await')
        ...
        function k(t, e) {
          ...
          const n = l(r, t.iterator, e.arg);
          if (n.type === 'throw') return (e.method = 'throw'), (e.arg = n.arg), (e.delegate = null), u;
          const o = n.arg;
          return o
            ? o.done
        ...
        function j(t) {
          (this.tryEntries = [{ tryLoc: 'root' }]), t.forEach(z, this), this.reset(!0);
        }
        function E(t) {
          if (t) {
            const e = t[o];
        ...
        return (
          ...
          c(y, 'constructor', d),
          c(d, 'constructor', f),
          (f.displayName = c(d, a, 'GeneratorFunction')),
          (t.isGeneratorFunction = function (t) {
            const e = typeof t === 'function' && t.constructor;
            return !!e && (e === f || (e.displayName || e.name) === 'GeneratorFunction');
          }),
          (t.mark = function (t) {
            return (
              Object.setPrototypeOf ? Object.setPrototypeOf(t, d) : ((t.__proto__ = d), c(t, a, 'GeneratorFunction')),
          ...
          (j.prototype = {
            ...
            finish(t) {
              for (let e = this.tryEntries.length - 1; e >= 0; --e) {
                ...
                if (r.finallyLoc === t) return this.complete(r.completion, r.afterLoc), L(r), u;
              }
            },
            catch(t) {
              for (let e = this.tryEntries.length - 1; e >= 0; --e) {
      ...
      function k() {
        ...
        const o = document.querySelector('.result-list');
        let i = {};
        const a = [];
        ...
        const s = function (t) {
          ...
          const n = e[r - 1];
          return n < 10 ? '0'.concat(n, '00') : ''.concat(n, '00');
        };
        const l = (function () {
          const t = x(
            v().mark(function t() {
                  ...
                  switch ((t.prev = t.next)) {
                    case 0:
                      return (
                        ...
                        (c.date = ''.concat(r).concat(n).concat(o)),
                        (c.time = s(e.getHours())),
                        t.abrupt('return', c)
                      );
                    case 7:
        ...
        const p = function (t) {
          for (
            var e = r.value.length === 1 ? t.target.innerText : r.value, o = 1, a = 0, s = Object.entries(i);
            a < s.length;
            a++
          ) {
            const u = b(s[a], 2);
            const p = (u[0], u[1]);
            p.name === e && (o = p['beach-num']);
          }
          r.value = e;
          const f = { num: o, name: e };
          l(), h('beachInfo', f), h('currentTime', { date: c.date, time: c.time }), n.submit();
        };
        const f = function (e) {
          t.searchCount >= t.searchMaxCount
            ? (t.searchCount = -1)
            : (t.searchCount > t.searchMaxCount || t.searchCount < 0) && (t.searchCount = t.searchMaxCount);
          const n = o.childNodes[t.searchCount];
          switch (e.key) {
            case 'ArrowUp':
              t.searchCount -= 1;
              break;
        ...
        r.addEventListener('keyup', (e) => {
          ...
          e.key !== 'backspace' &&
            ...
            (n = r.value) !== '' &&
              (i = a
                .filter((t) => t.toLowerCase().startsWith(n))
                .map((t) => '<li>'.concat(t, '</li>'))
                .join('')),
            (o.innerHTML = i),
            (t.searchMaxCount = o.childElementCount)),
            (e.key !== 'ArrowUp' && e.key !== 'ArrowDown') || f(e);
        }),
          r.addEventListener('keydown', (t) => {
            t.key === 'Enter' && (t.preventDefault(), f(t));
          }),
