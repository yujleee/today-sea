...
(() => {
            ...
            for (let u = 0; u < t.length; u++) {
              ...
              (n && a[l[0]]) ||
                (void 0 !== i &&
                  ...
                  (l[5] = i)),
                r && (l[2] ? ((l[1] = '@media '.concat(l[2], ' {').concat(l[1], '}')), (l[2] = r)) : (l[2] = r)),
                o &&
                  (l[4]
    ...
    379: (t) => {
      ...
      function n(t, n) {
        for (var i = {}, a = [], c = 0; c < t.length; c++) {
          ...
          if (p !== -1) e[p].references++, e[p].updater(h);
          else {
            const m = o(h, n);
            (n.byIndex = c), e.splice(c, 0, { identifier: f, updater: m, references: 1 });
          }
          a.push(f);
        }
        return a;
      ...
      t.exports = function (t, o) {
        ...
        return function (t) {
          ...
          for (var s = n(t, o), u = 0; u < i.length; u++) {
            const l = r(i[u]);
            e[l].references === 0 && (e[l].updater(), e.splice(l, 1));
          }
          i = s;
        };
      };
  ...
  (r.n = (t) => {
    ...
    (r.d = (t, e) => {
      for (const n in e) r.o(e, n) && !r.o(t, n) && Object.defineProperty(t, n, { enumerable: !0, get: e[n] });
    }),
    ...
    (() => {
      ...
      function v() {
        ...
        function s(t, e, r, n) {
          const o = e && e.prototype instanceof f ? e : f;
            ...
            (i._invoke = (function (t, e, r) {
              ...
              return function (o, i) {
                ...
                for (r.method = o, r.arg = i; ; ) {
                  ...
                  s.type === 'throw' && ((n = 'completed'), (r.method = 'throw'), (r.arg = s.arg));
                }
              };
            })(t, r, a)),
            i
        ...
        const g = d && d(d(z([])));
        g && g !== e && r.call(g, o) && (m = g);
        const b = (h.prototype = f.prototype = Object.create(m));
        function w(t) {
        ...
        function x(t, e) {
          function n(o, i, a, c) {
            ...
            if (s.type !== 'throw') {
              const l = s.arg;
              const f = l.value;
              return f && y(f) == 'object' && r.call(f, '__await')
        ...
        function k(t, e) {
          ...
          if (void 0 === r) {
            if (((e.delegate = null), e.method === 'throw')) {
              if (t.iterator.return && ((e.method = 'return'), (e.arg = void 0), k(t, e), e.method === 'throw')) {
                return l;
              }
        ...
        return (
          ...
          (E.prototype = {
            ...
            delegateYield(t, e, r) {
              return (
                (this.delegate = { iterator: z(t), resultName: e, nextLoc: r }),
      ...
      new (function () {
        ...
        const n = document.querySelector('.result-list');
        let o = {};
        const i = [];
        ...
        const c = function (t) {
          for (
            var n = e.value.length === 1 ? t.target.innerText : e.value, i = 1, a = 0, c = Object.entries(o);
            a < c.length;
            a++
          ) {
            const s = b(c[a], 2);
            const u = (s[0], s[1]);
            u.name === n && (i = u['beach-num']);
          }
          (e.value = n), d('beachInfo', { num: i, name: n }), r.submit();
        };
        const s = function (r) {
          t.searchCount >= t.searchMaxCount
            ? (t.searchCount = -1)
            : (t.searchCount > t.searchMaxCount || t.searchCount < 0) && (t.searchCount = t.searchMaxCount);
          const o = n.childNodes[t.searchCount];
          switch (r.key) {
            case 'ArrowUp':
              t.searchCount -= 1;
              break;
        ...
        e.addEventListener('keyup', (r) => {
          ...
          r.key !== 'backspace' &&
            ...
            (o = e.value) !== '' &&
              (a = i
                .filter((t) => t.toLowerCase().startsWith(o))
                .map((t) => '<li>'.concat(t, '</li>'))
                .join('')),
            (n.innerHTML = a),
            (t.searchMaxCount = n.childElementCount)),
            (r.key !== 'ArrowUp' && r.key !== 'ArrowDown') || s(r);
        }),
          e.addEventListener('keydown', (t) => {
            t.key === 'Enter' && (t.preventDefault(), s(t));
          }),
      ...
      const S = Number(g('currentTime').time);
      function L(t, e) {
        (e == null || e > t.length) && (e = t.length);
        for (var r = 0, n = new Array(e); r < e; r++) n[r] = t[r];
        return n;
      }
      const E = g('beachInfo').name;
      const z = g('currentTime').time;
      const T = document.querySelector('.beach-info-top');
      const j = document.querySelector('.info-area');
      const _ = {
        45: '북-북동',
        90: '북동-동',
        135: '동-남동',
      ...
      const O = function (t) {
        ...
        const a =
          ...
          (r = {}),
          e.item.forEach((t) => {
            r[t.category] = t.fcstValue;
          }),
          r);
        (T.querySelector('.beach-name').innerText = E),
          (T.querySelector('.base-time').innerText = '오늘 '.concat(z.slice(0, 2), '시 기준')),
          T.querySelector('.weather-img img').setAttribute(
            'src',
            ((n = a.SKY),
            (o = a.PTY),
            (i = ''),
            S >= 2e3
              ? k.find((t) => t.name === 'night').img
              : (Number(o) === 0 && (i = k.find((t) => t.img_id === Number(n)).img),
                Number(o) >= 1 && (i = k.find((t) => t.img_id === Number(o) + 1).img),
                i))
          ),
          (T.querySelector('.current-temp').innerText = ''.concat(a.TMP, '°')),
          (j.querySelector('.humidty').innerText = ''.concat(a.REH, '%')),
          (j.querySelector('.wave').innerText = ''.concat(a.WAV)),
          (j.querySelector('.wind-speed').innerText = ''.concat(a.WSD)),
          (j.querySelector('.wind-direction').innerText = ''.concat(
            (function (t) {
              for (var e = '', r = 0, n = Object.entries(_); r < n.length; r++) {
                const o =
                  ((c = n[r]),
                  (s = 2),
                  (function (t) {
      ...
      const N = document.querySelector('.info-area');
      const C = function (t) {
        let e;
        const r = {
        ...
        (N.querySelector('.sunrise').innerText = r.sunrise), (N.querySelector('.sunset').innerText = r.sunset);
      };
      const A = document.querySelector('.info-area');
      const I = g('currentTime').time;
      const q = ['ET1', 'FT1', 'ET2', 'FT2'];
      const P = function (t) {
        let e;
        let r;
        let n;
        const o =
          ...
          (n = {}),
          r[0].forEach((t) => {
            t.tiType === '-' && q.forEach((t) => (n[t] = '정보없음')), (n[t.tiType] = t.tiTime);
          }),
          n);
        let i = '';
        let a = '';
        Number(I.slice(0, 2)) < 12 ? ((i = o.ET1), (a = o.FT1)) : ((i = o.ET2), (a = o.FT2)),
          (A.querySelector('.ebb-tide').innerText = ''.concat(i)),
          (A.querySelector('.flood-tide').innerText = ''.concat(a));
      };
      function F(t) {
        return (
          (F =
      ...
      function M() {
        ...
        const g = d && d(d(L([])));
        g && g !== e && r.call(g, o) && (m = g);
        const y = (h.prototype = f.prototype = Object.create(m));
        function v(t) {
          ['next', 'throw', 'return'].forEach((e) => {
            c(t, e, function (t) {
              return this._invoke(e, t);
        ...
        function b(t, e) {
          function n(o, i, a, c) {
            ...
            if (s.type !== 'throw') {
              const l = s.arg;
              const f = l.value;
              return f && F(f) == 'object' && r.call(f, '__await')
                ? e.resolve(f.__await).then(
                    (t) => {
                      n('next', t, a, c);
                    },
        ...
        function w(t, e) {
          ...
          if (void 0 === r) {
            if (((e.delegate = null), e.method === 'throw')) {
              if (t.iterator.return && ((e.method = 'return'), (e.arg = void 0), w(t, e), e.method === 'throw')) {
                return l;
              }
              (e.method = 'throw'), (e.arg = new TypeError("The iterator does not provide a 'throw' method"));
            }
      ...
      const J = 'https://apis.data.go.kr/1360000/BeachInfoservice';
      const R = 'JgOTEFegmT85gM1vQ7XNalEJFJb0gusFB26pkZkBameKaU3B5WlTltcyt6xWvGR8aNvLvw7Jw6gqnQSiMm6KgQ%3D%3D';
      const D = [2, 5, 8, 11, 14, 17, 20, 23];
      const B = g('beachInfo').num;
      const X = {};
      const U = function (t) {
        const e = D.find((e) => t <= e);
                ...
                switch ((t.prev = t.next)) {
                  case 0:
                    return (
                      (e = new Date()),
                      (r = e.getFullYear()),
                      (n = e.toLocaleString('ko-KO', { month: '2-digit' }).slice(0, 2)),
                      (o = e.toLocaleString('ko-KO', { day: '2-digit' }).slice(0, 2)),
                      (X.date = ''.concat(r).concat(n).concat(o)),
                      (X.time = U(e.getHours())),
                      console.log(X.time),
                      t.abrupt('return', X)
                    );
              ...
              for (;;) {
                switch ((t.prev = t.next)) {
                  case 0:
                    fetch(
                      ''
                        .concat(J, '/getVilageFcstBeach?serviceKey=')
                        .concat(R, '&dataType=JSON&base_date=')
                        .concat(X.date, '&base_time=')
                        .concat(X.time, '&beach_num=')
                        .concat(B, '&numOfRows=20')
                    )
                      .then((t) => t.json())
                      .then((t) => {
                        document.querySelector('.loading').classList.remove('before-load'), O(t);
                      })
                      .catch((t) => {
                        console.error(t);
                      });
              ...
              for (;;) {
                switch ((t.prev = t.next)) {
                  case 0:
                    fetch(
                      ''
                        .concat(J, '/getSunInfoBeach?serviceKey=')
                        .concat(R, '&dataType=JSON&base_date=')
                        .concat(X.date, '&beach_num=')
                        .concat(B)
                    )
                      .then((t) => t.json())
                      .then((t) => C(t))
              ...
              for (;;) {
                switch ((t.prev = t.next)) {
                  case 0:
                    fetch(
                      ''
                        .concat(J, '/getTideInfoBeach?serviceKey=')
                        .concat(R, '&dataType=JSON&base_date=')
                        .concat(X.date, '&beach_num=')
                        .concat(B)
                    )
              ...
              for (;;) {
                switch ((t.prev = t.next)) {
                  case 0:
                    return (t.next = 2), Y();
                  case 2:
                    return d('currentTime', { date: X.date, time: X.time }), (t.next = 5), Z();
                  case 5:
                    return (t.next = 7), H();
                  case 7:
                    return (t.next = 9), W();
